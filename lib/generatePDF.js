const PDF_LABELS = {
  ...
  es: {
    ...
    hd_type: 'Tipo',
    hd_profile: 'Perfil',
    hd_strategy: 'Estrategia',
    hd_authority: 'Autoridad',
  ...
  fr: {
    ...
    hd_type: 'Type',
    hd_profile: 'Profil',
    hd_strategy: 'Stratégie',
    hd_authority: 'Autorité',
  ...
  it: {
    ...
    hd_type: 'Tipo',
    hd_profile: 'Profilo',
    hd_strategy: 'Strategia',
    hd_authority: 'Autorità',
  ...
  pt: {
    ...
    hd_type: 'Tipo',
    hd_profile: 'Perfil',
    hd_strategy: 'Estratégia',
    hd_authority: 'Autoridade',
    blueprint: 'Plano Energético Central',
  ...
  hu: {
    ...
    hd_type: 'Típus',
    hd_profile: 'Profil',
    hd_strategy: 'Stratégia',
    hd_authority: 'Autoritás',
