...
const PDF_LABELS = {
  en: {
    ...
    central_tension: 'The Tension You Live With', friction_daily: 'In daily life', friction_resolution: 'How to hold both',
    aligned_life: 'Life in Alignment', decision_system: 'Your Decision System',
    energy_manual: 'Your Energy Manual', energy_peak: 'When you peak', energy_drain: 'What drains you', energy_rhythm: 'Your natural rhythm', energy_year: 'Your personal year', energy_watch_for: 'Signs to notice',
    warning_signals: 'Warning Signals',
    blueprint: 'Core Energetic Blueprint', strengths: 'Strengths', vulnerabilities: 'Growth Opportunities',
  ...
  ro: {
    ...
    central_tension: 'Tensiunea cu Care Trăiești', friction_daily: 'În viața de zi cu zi', friction_resolution: 'Cum le ții pe amândouă',
    aligned_life: 'Viața în Aliniere', decision_system: 'Sistemul Tău de Decizie',
    energy_manual: 'Manualul Energiei Tale', energy_peak: 'Când ești la vârf', energy_drain: 'Ce te epuizează', energy_rhythm: 'Ritmul tău natural', energy_year: 'Anul tău personal', energy_watch_for: 'Semne de observat',
    warning_signals: 'Semnale de Avertizare',
    blueprint: 'Planul Energetic Central', strengths: 'Puncte Forte', vulnerabilities: 'Oportunități de Creștere',
  ...
  es: {
    ...
    central_tension: 'La Tensión con la que Vives', friction_daily: 'En el día a día', friction_resolution: 'Cómo sostener ambas',
    aligned_life: 'La Vida en Alineación', decision_system: 'Tu Sistema de Decisión',
    energy_manual: 'El Manual de Tu Energía', energy_peak: 'Cuando estás al máximo', energy_drain: 'Qué te agota', energy_rhythm: 'Tu ritmo natural', energy_year: 'Tu año personal', energy_watch_for: 'Señales a notar',
    warning_signals: 'Señales de Alerta',
    blueprint: 'Plano Energético Central', strengths: 'Fortalezas', vulnerabilities: 'Oportunidades de Crecimiento',
  ...
  fr: {
    ...
    central_tension: 'La Tension Avec Laquelle Tu Vis', friction_daily: 'Au quotidien', friction_resolution: 'Comment tenir les deux',
    aligned_life: 'La Vie en Alignement', decision_system: 'Votre Système de Décision',
    energy_manual: 'Le Manuel de Votre Énergie', energy_peak: 'Quand vous êtes au sommet', energy_drain: 'Ce qui vous épuise', energy_rhythm: 'Votre rythme naturel', energy_year: 'Votre année personnelle', energy_watch_for: 'Signes à remarquer',
    warning_signals: "Signaux d'Alerte",
    blueprint: 'Plan Énergétique Central', strengths: 'Forces', vulnerabilities: 'Opportunités de Croissance',
  ...
  de: {
    ...
    central_tension: 'Die Spannung, Mit der Du Lebst', friction_daily: 'Im Alltag', friction_resolution: 'Wie du beide hältst',
    aligned_life: 'Das Leben im Einklang', decision_system: 'Dein Entscheidungssystem',
    energy_manual: 'Dein Energie-Handbuch', energy_peak: 'Wann du am stärksten bist', energy_drain: 'Was dich auslaugt', energy_rhythm: 'Dein natürlicher Rhythmus', energy_year: 'Dein persönliches Jahr', energy_watch_for: 'Anzeichen, auf die du achten kannst',
    warning_signals: 'Warnsignale',
    blueprint: 'Zentraler Energieplan', strengths: 'Stärken', vulnerabilities: 'Wachstumschancen',
  ...
  it: {
    ...
    central_tension: 'La Tensione con Cui Vivi', friction_daily: 'Nella vita quotidiana', friction_resolution: 'Come tenerle entrambe',
    aligned_life: 'La Vita in Allineamento', decision_system: 'Il Tuo Sistema Decisionale',
    energy_manual: 'Il Manuale della Tua Energia', energy_peak: 'Quando sei al massimo', energy_drain: 'Cosa ti svuota', energy_rhythm: 'Il tuo ritmo naturale', energy_year: 'Il tuo anno personale', energy_watch_for: 'Segnali da notare',
    warning_signals: 'Segnali di Allerta',
    blueprint: 'Piano Energetico Centrale', strengths: 'Punti di Forza', vulnerabilities: 'Opportunità di Crescita',
  ...
  pt: {
    ...
    central_tension: 'A Tensão com a Qual Vives', friction_daily: 'No dia a dia', friction_resolution: 'Como manter as duas',
    aligned_life: 'A Vida em Alinhamento', decision_system: 'Seu Sistema de Decisão',
    energy_manual: 'O Manual da Sua Energia', energy_peak: 'Quando você está no auge', energy_drain: 'O que te esgota', energy_rhythm: 'Seu ritmo natural', energy_year: 'Seu ano pessoal', energy_watch_for: 'Sinais a notar',
    warning_signals: 'Sinais de Alerta',
    blueprint: 'Plano Energético Central', strengths: 'Forças', vulnerabilities: 'Oportunidades de Crescimento',
  ...
  nl: {
    ...
    central_tension: 'De Spanning Waarmee Je Leeft', friction_daily: 'In het dagelijks leven', friction_resolution: 'Hoe je beide vasthoudt',
    aligned_life: 'Het Leven in Afstemming', decision_system: 'Jouw Beslissingssysteem',
    energy_manual: 'Jouw Energiehandboek', energy_peak: 'Wanneer je op je best bent', energy_drain: 'Wat je uitput', energy_rhythm: 'Jouw natuurlijke ritme', energy_year: 'Jouw persoonlijke jaar', energy_watch_for: 'Signalen om op te letten',
    warning_signals: 'Waarschuwingssignalen',
    blueprint: 'Centraal Energetisch Blauwdruk', strengths: 'Sterktes', vulnerabilities: 'Groeikansen',
  ...
  pl: {
    ...
    central_tension: 'Napięcie, z Którym Żyjesz', friction_daily: 'W codziennym życiu', friction_resolution: 'Jak utrzymać obie',
    aligned_life: 'Życie w Zgodzie', decision_system: 'Twój System Decyzyjny',
    energy_manual: 'Podręcznik Twojej Energii', energy_peak: 'Kiedy jesteś u szczytu', energy_drain: 'Co cię wyczerpuje', energy_rhythm: 'Twój naturalny rytm', energy_year: 'Twój rok osobisty', energy_watch_for: 'Sygnały, na które warto zwrócić uwagę',
    warning_signals: 'Sygnały Ostrzegawcze',
    blueprint: 'Centralny Plan Energetyczny', strengths: 'Mocne Strony', vulnerabilities: 'Możliwości Rozwoju',
  ...
  hu: {
    ...
    central_tension: 'A Feszültség, Amellyel Élsz', friction_daily: 'A mindennapokban', friction_resolution: 'Hogyan tartsa mindkettőt',
    aligned_life: 'Élet Összhangban', decision_system: 'Az Ön Döntési Rendszere',
    energy_manual: 'Az Ön Energia Kézikönyve', energy_peak: 'Amikor csúcson van', energy_drain: 'Mi meríti ki', energy_rhythm: 'Az Ön természetes ritmusa', energy_year: 'Az Ön személyes éve', energy_watch_for: 'Figyelendő jelek',
    warning_signals: 'Figyelmeztető Jelek',
    blueprint: 'Központi Energetikai Terv', strengths: 'Erősségek', vulnerabilities: 'Növekedési Lehetőségek',
  ...
  ru: {
    ...
    central_tension: 'Напряжение, с Которым Ты Живёшь', friction_daily: 'В повседневной жизни', friction_resolution: 'Как удерживать оба полюса',
    aligned_life: 'Жизнь в Согласии', decision_system: 'Твоя Система Принятия Решений',
    energy_manual: 'Твой Энергетический Гид', energy_peak: 'Когда ты на пике', energy_drain: 'Что тебя истощает', energy_rhythm: 'Твой природный ритм', energy_year: 'Твой личный год', energy_watch_for: 'Признаки, на которые стоит обратить внимание',
    warning_signals: 'Предупреждающие Сигналы',
    blueprint: 'Центральный Энергетический Чертёж', strengths: 'Сильные Стороны', vulnerabilities: 'Возможности Роста',
...
export async function generateProfilePDF(profile) {
  const { full_name, sections, swot, language = 'en', personal_year, hd_data } = profile
  ...
  if (isV4) {
    ...
    const tension = (sections.central_tension && typeof sections.central_tension === 'object' && sections.central_tension.tension)
      ? sections.central_tension : null
    const energy = sections.energy_manual
    const watchFor = Array.isArray(sections.energy_manual?.watch_for) ? sections.energy_manual.watch_for.filter(Boolean) : []
    ...
    if (Array.isArray(sections.strengths) && sections.strengths.length) {
      sectionsHtml += `<div class="section"><div class="tag tg">${esc(L.strengths)}</div><ul>${bullets(sections.strengths, '#c9963f')}</ul></div>`
    }

    // 3. Sistemul tău de decizie
    if (decision.length) {
    ...
    // 4. Manualul energiei — absoarbe fostele Semnale de Alarmă (watch_for)
    if (energy && (energy.peak || energy.drain || energy.rhythm || energy.current_year || watchFor.length)) {
      sectionsHtml += `<div class="section"><div class="tag tp">${esc(L.energy_manual)}</div>
        ...
        ${watchFor.length ? `<div style="margin-top:10px"><div class="sub" style="color:var(--text-light)">${esc(L.energy_watch_for)}</div>${watchFor.map(wf => `<p class="blueprint" style="margin-bottom:4px">${esc(wf)}</p>`).join('')}</div>` : ''}
      </div>`
    }

    // 5. Tensiunea cu care trăiești — UNA singură, polii numiți, fără litere
    if (tension) {
      sectionsHtml += `<div class="section"><div class="tag to">${esc(L.central_tension)}</div>
        <div class="friction">
          ${tension.tension ? `<div class="friction-name">${esc(tension.tension)}</div>` : ''}
          <div class="g2" style="margin-bottom:4px">
            ${tension.pull_a ? `<div class="pull pull-a">${esc(tension.pull_a)}</div>` : ''}
            ${tension.pull_b ? `<div class="pull pull-b">${esc(tension.pull_b)}</div>` : ''}
          </div>
          ${tension.daily_experience ? `<p class="fmeta"><b>${esc(L.friction_daily)}:</b> ${esc(tension.daily_experience)}</p>` : ''}
          ${tension.resolution ? `<p class="fmeta"><b>${esc(L.friction_resolution)}:</b> ${esc(tension.resolution)}</p>` : ''}
        </div>
      </div>`
    }
...
<div class="footer">${esc(APP_NAME)} — ${esc(L.footer)}</div>
</div>
</body>
</html>`
