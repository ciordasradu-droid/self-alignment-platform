...

{
  ...
  "strengths": [
    "Write each strength as a full paragraph of 2-4 sentences. Lead with the human truth. Then explain the gate, channel, or number behind it — what that energy actually IS, not just what it gives them. End with one sentence about when this strength is at its best.",
  ...
  "vulnerabilities": [
    "Write each as a full paragraph of 2-4 sentences. Name the pattern honestly. Explain which part of their data creates this tendency — gate, undefined center, or number. End with one concrete thing they can do differently. Frame as growth, not flaw.",
