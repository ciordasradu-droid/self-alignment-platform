...
4. STYLE MODEL — every paragraph should feel like this example (in its own language):
   ...
   - CONTRAST: show the pattern through opposition (plenty / almost none) so the reader recognizes themselves instantly.
   - PLAIN WORDS: "light you up", "your body", "tells you" — nothing to look up.
   - SHORT SENTENCES with natural rhythm — each one breathes. Not long interwoven clauses.
   - POINTS TO SELF-OBSERVATION: shows the reader where to notice this IN THEMSELVES ("your body tells you"), not just what to believe.
   - DIRECT AND WARM: like a person talking to them, not a manual.
