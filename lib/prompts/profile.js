...
5. NO REPETITION ACROSS SECTIONS. Say something once, in the best place. In later sections, reference: "that tension between X and Y" — don't re-explain it.
...
9. LENGTH DISCIPLINE. Say it in 2 sentences if you can. The entire profile should be 2500-3500 words, not more.
...
{
  "archetype": {
    "name": "A 2-4 word evocative name that captures who this person is across all three systems. Not mystical — grounded. Examples: 'The Quiet Architect', 'The Reluctant Leader', 'The Builder Who Craves Meaning'. Make this specific person feel recognized.",
  ...
  "how_you_work": {
    ...
    "engine": "2-3 sentences. How they actually operate day-to-day — work rhythm, what energizes vs drains. Draw from: HD type + strategy + expression number + relevant defined centers. Specific enough to evaluate their current job against.",
    "core": "2-3 sentences. What drives them underneath — the need they might not show anyone. Draw from: life path + soul urge + incarnation cross. This paragraph should make them pause."
  },

  "friction_map": [
    {
      "tension": "Short name for this internal conflict — 3-5 words",
      "pull_a": "What one part of the data says — be specific about which system and element. 1-2 sentences.",
      "pull_b": "What the opposing part says — different system. 1-2 sentences.",
      "daily_experience": "How this shows up in their daily life. 2 sentences. Concrete, recognizable.",
      "resolution": "How to hold both — not choose one. 2 sentences. Practical."
    },
    "Same format — 3-4 friction points total. Each must involve a REAL clash between different parts of the data.",
  ...
  "warning_signals": [
    {
      ...
      "pattern": "What is actually happening — traced to their profile. 1-2 sentences.",
      "exit": "One concrete action. Not 'meditate.' Something specific and time-bound."
    },
    "Same format — 3-4 signals total. Each from a DIFFERENT part of the data."
  ],
  ...
  "commitments": [
    "Written as 'I commit to...' — specific, personal, grounded in their design. 2-3 sentences.",
    "Written as 'I commit to...' — grounded in HD type. 2-3 sentences.",
    "Written as 'I commit to...' — grounded in personal year ${n.personal_year?.personal_year}. 2-3 sentences."
  ],
  ...
  "glossary": {
    ...
    "terms": [
      ...
      { "term": "Expression Number", "definition": "From your full name at birth — describes how you naturally express yourself." },
      { "term": "Soul Urge", "definition": "From the vowels of your name — what you truly desire inside." },
      { "term": "Personal Year", "definition": "One of 9 years in a numerological cycle. Each has a different theme." },
      { "term": "Type", "definition": "In Human Design, 5 types of people — each with a different energy strategy." },
      ...
      { "term": "Gate", "definition": "A specific theme in your design — each colors how you see an area of life." },
      { "term": "Channel", "definition": "Two compatible active gates form a channel — a consistent energy flow." },
...
9. Total length 2500-3500 words.
...

{
  ...
  "behavioral_anchors": {
    ...
    "forbidden_behaviors": [
      "REQUIRED — name a specific behavior that derails this person based on their warning signal or undefined centers. Explain exactly why it hurts them.",
