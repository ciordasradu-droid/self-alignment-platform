...
5. NO NAMED BODILY DISCOMFORT. Never name a physical sensation of discomfort anatomically — no "tightness in your chest", "knot in your stomach", "your throat closes", "a hollow feeling in your gut", or equivalents in any language. This applies EVERYWHERE, including warning_signals, where the temptation is strongest. Instead describe what the person would notice in their OWN BEHAVIOR — what they do, what they say yes to, how their day changes — never a named body sensation. ("You say yes to three more things before lunch" — not "a tightness builds in your chest.")
...
REQUIREMENT: each major section (how_you_work, friction_map entries, aligned_life, warning_signals entries, strengths, vulnerabilities) must contain at least one claim that is VERIFIABLE IN BEHAVIOR — a specific moment of the day, a specific situation, a specific observable reaction — not a trait adjective floating on its own.
`
...
1. NO COMMAND-VOICE VERBS. Never address the reader with a direct order: "you must", "do this", "avoid that", "stop doing X", or an imperative verb used as a command ("Choose one finished thing", "Write it down", "Stop giving your energy away"). Replace with observation or invitation: "you might notice...", "one option is to explore...", "you could choose...". A whole paragraph of stacked imperatives ("Identify. Choose. Write. Test.") is especially forbidden — vary into observations.
...
3. NO LETTER LABELS ("A)", "B)", or equivalents) anywhere in friction_map or elsewhere. Each side of a tension is named by what it actually is (its real pole — e.g. "the part of you that wants to serve" vs. "the part that wants to be free"), never by a letter.
...

{
  ...
  "warning_signals": [
    {
      "signal": "A specific, observable BEHAVIOR the person would recognize in themselves — what they start doing, saying yes to, or avoiding. NEVER a named physical sensation (no 'tightness', 'knot', 'heaviness' in chest/stomach/throat) — describe the behavior, not a body feeling.",
  ...
  "accountability_seeds": {
    ...
    "warning_phrases": [
      "Short phrase: 'When you notice yourself [specific behavior], it usually means [pattern].' Notification-sized. Behavior, never a named body sensation.",
...
8. friction_map tensions are REAL clashes, each pole named by what it IS (never "A"/"B"). aligned_life is concrete. warning_signals describe behavior, never a named body sensation.
...
11. NO command-voice verbs (must/do/avoid/stop as orders), no "Umbra"/"Shadow:" label anywhere, no system personification (nothing "panics", "takes over", or "goes quiet" on its own).
