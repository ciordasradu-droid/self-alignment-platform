...
You have been given complete calculated data from three systems. Your job is to synthesize them into a profile that feels uncannily specific to this exact person — not generic to their type or sign.
...

{
  ...
  "strengths": [
    "Strength 1 — must name a specific gate, channel, or number that explains WHY this is a strength for this person",
    "Strength 2 — same rule",
    "Strength 3 — same rule",
    "Strength 4 — same rule",
    "Strength 5 — same rule"
  ],

  "vulnerabilities": [
    "Growth area 1 — must reference a specific piece of data (gate, undefined center, number) and frame it as an opportunity, not a flaw",
    "Growth area 2 — same rule",
    "Growth area 3 — same rule",
    "Growth area 4 — same rule"
  ],

  "energy_patterns": [
    "Pattern 1 — specific to this person's defined/undefined centers and HD type",
    "Pattern 2 — reference a specific gate or channel",
    "Pattern 3 — reference astrology element or modality",
    "Pattern 4 — reference personal year energy"
  ],

  "sabotage_tendencies": [
    "Tendency 1 — must name the not-self theme and link it to a specific undefined center or gate",
    "Tendency 2 — link to a numerology number",
    "Tendency 3 — link to astrology modality or element",
    "Tendency 4 — name a specific behavioral pattern from the data"
  ],

  "decision_making": [
    "Style 1 — explain this person's ${hd.authority} authority in plain language with a concrete example",
    "Style 2 — name a gate or channel that colors HOW they process decisions",
    "Style 3 — reference the numerology soul urge as a motivational filter"
  ],

  "work_discipline": [
    "Point 1 — specific to their HD type and channels",
    "Point 2 — reference a specific gate related to work or energy",
    "Point 3 — tie to expression number and what it says about how they engage professionally",
    "Point 4 — reference the current personal year theme as a work lens"
  ],

  "commitments": [
    "I commit to [specific agreement based on their biggest sabotage pattern — reference the gate or center behind it]",
    "I commit to [specific agreement based on their energy type and how they work best — name the HD type]",
    "I commit to [specific agreement aligned with their Personal Year ${n.personal_year?.personal_year} theme — name the theme]"
  ]
}`
}
...
{
  "strengths": [
    "Natural gift 1 — reference a specific gate or channel",
    "Natural gift 2 — reference a specific number",
    "Natural gift 3 — reference defined center or cross",
    "Natural gift 4 — reference astrology or profile line"
  ],
  "weaknesses": [
    "Growth edge 1 — name the specific gate or undefined center behind this pattern",
    "Growth edge 2 — link to a number",
    "Growth edge 3 — link to modality or element",
    "Growth edge 4 — link to not-self theme"
  ],
  "opportunities": [
    "Opportunity 1 — specific to their current Personal Year theme",
    "Opportunity 2 — tied to incarnation cross purpose",
    "Opportunity 3 — tied to a specific channel or gate",
    "Opportunity 4 — tied to expression or life path number"
  ],
  "threats": [
    "Pattern to release 1 — name the gate or center behind it",
    "Pattern to release 2 — name the numerology pattern",
    "Pattern to release 3 — name the conditioning from an undefined center",
    "Pattern to release 4 — name a specific behavioral loop from the data"
  ]
}`
}
...
RULES:
- Every item must be concrete and specific to this person's data — not generic advice.
...
{
  "directional_clarity": {
    "life_direction": "2-3 warm inspiring sentences about this person's natural direction — must name their incarnation cross and life path number",
    "prioritize": [
      "Priority 1 — tied to a specific gate or channel",
      "Priority 2 — tied to their HD type's signature",
      "Priority 3 — tied to their expression or life path number"
    ],
    "eliminate": [
      "Drain 1 — tied to not-self theme or a specific gate",
      "Drain 2 — tied to an undefined center being over-activated",
      "Drain 3 — tied to a numerology or astrology pattern"
    ]
  },
  "structured_plan": {
  ...
  "behavioral_anchors": {
    "keystone_habits": [
      "Habit 1 — name the gate or channel it supports",
      "Habit 2 — name the number it aligns with",
      "Habit 3 — name the HD type or authority it honors"
    ],
    "forbidden_behaviors": [
      "Never [specific behavior] — this triggers your ${hd.not_self_theme} response from [specific gate or center]",
      "Never [specific behavior] — this activates the shadow side of [specific number or sign trait]",
      "Never [specific behavior] — this works against [specific strategy or channel]"
    ],
    "non_negotiables": [
      "I [specific agreement] — this honors Gate [number] / Channel [name] in my design",
      "I [specific agreement] — this aligns with my Life Path ${n.life_path} as ${n.life_path_meaning}",
      "I [specific agreement] — this supports my Personal Year ${n.personal_year?.personal_year} theme of ${n.personal_year?.theme}"
    ]
  }
}`
}
...
This is not generic wellness advice — it is a custom prescription derived from their unique design.
...
3. Every practice must have a why_for_you that names a specific gate number, channel name, defined center, or numerology number — not just the type.
...
5. Duration must be realistic — between 5 and 30 minutes.
