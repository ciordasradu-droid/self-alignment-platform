...
export function calculateFullProfile(fullName, dateOfBirth, timeOfBirth, lat, lng, language = 'en', birthTimeUnknown = false) {
  ...
  humanDesign.birth_time_unknown = !!birthTimeUnknown
...
function buildEnrichedContext(numerology, astrology, humanDesign) {
  ...
  return {
    ...
    human_design: {
      birth_time_unknown: !!hd.birth_time_unknown,
      type:             hd.type,
      profile:          hd.profile,
