...
// GCAO 05.08.2026 — "Apa vie, zi și seară". Înlocuiește FEATURE_BUBBLE
// (03.08.2026, retras — bula nu mai e un canvas local de oprit separat, e
// parte a WaterWorld). Implicit ACTIVĂ — un singur loc de oprire dacă apar
// probleme de performanță: NEXT_PUBLIC_FEATURE_WATER_WORLD=false în Vercel
// revine la fostul fundal video (WaterVideoLayer), fără alt cod.
export const FEATURE_WATER_WORLD = process.env.NEXT_PUBLIC_FEATURE_WATER_WORLD !== 'false'
