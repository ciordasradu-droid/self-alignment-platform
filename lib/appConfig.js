...
// semnată de Alex). Implicit ACTIVĂ (spre deosebire de FEATURE_BREATH) — un
// singur loc de oprire dacă apar probleme de performanță pe unele device-uri:
// NEXT_PUBLIC_FEATURE_BUBBLE=false în Vercel o dezactivează fără alt cod.
export const FEATURE_BUBBLE = process.env.NEXT_PUBLIC_FEATURE_BUBBLE !== 'false'
