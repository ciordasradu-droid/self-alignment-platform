        ...
        <body style="margin:0;padding:0;background:#fafaf8;font-family:'DM Sans',sans-serif;">
          <div style="max-width:520px;margin:40px auto;padding:0 24px;">
            ...
            <div style="text-align:center;margin-bottom:32px;">
              <p style="font-size:28px;font-weight:600;font-family:Georgia,serif;color:#1a1a1a;margin:0;">${APP_NAME}</p>
            </div>

            <div style="background:#fff;border-radius:16px;border:1px solid #e8e8e4;padding:36px;">
              <p style="font-size:13px;font-weight:600;color:#8a6425;text-transform:uppercase;letter-spacing:1px;margin:0 0 12px;">Daily Check-in</p>
              ...
              <a href="${process.env.NEXT_PUBLIC_APP_URL}/dashboard" style="display:inline-block;padding:14px 28px;background:#c9963f;color:#fff;border-radius:10px;font-size:15px;font-weight:500;text-decoration:none;">
                Open my dashboard →
              </a>
            </div>

            <div style="margin-top:24px;padding:20px;background:#fdf8ef;border-radius:12px;">
              <p style="font-size:13px;color:#8a6425;line-height:1.6;margin:0;">
            ...
            <p style="text-align:center;font-size:12px;color:#999;margin-top:24px;">
              You're receiving this because you signed up for the ${APP_NAME} Accountability System.<br/>
              <a href="${process.env.NEXT_PUBLIC_APP_URL}" style="color:#8a6425;">Manage preferences</a>
            </p>
      ...
      <html>
        <body style="margin:0;padding:0;background:#fafaf8;font-family:'DM Sans',sans-serif;">
          <div style="max-width:520px;margin:40px auto;padding:0 24px;">
            ...
            <div style="background:#fff;border-radius:16px;border:1px solid #e8e8e4;padding:36px;">
              <p style="font-size:13px;font-weight:600;color:#8a6425;text-transform:uppercase;letter-spacing:1px;margin:0 0 12px;">Weekly Review</p>
              <h1 style="font-size:28px;font-weight:600;color:#1a1a1a;font-family:Georgia,serif;margin:0 0 16px;line-height:1.3;">
