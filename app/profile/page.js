...
function ProfileContent() {
  ...
  if (loading) return <div style={s.center}>Generating your profile...</div>
      ...
      <main style={s.wrap}>
        ...
        <div style={s.grid2}>
          ...
          <div style={{...s.card, borderLeft:'4px solid var(--orange)'}}>
            <div style={s.cardLabel('var(--orange-light)', 'var(--orange)')}>Natural Vulnerabilities</div>
            <ul style={s.list}>
        ...
        <div style={s.grid2}>
          ...
          <div style={{...s.card, borderLeft:'4px solid var(--orange)'}}>
            <div style={s.cardLabel('var(--orange-light)', 'var(--orange)')}>Self-Sabotage Tendencies</div>
            <ul style={s.list}>
        ...
        {/* SWOT */}
        <div style={s.card}>
          <div style={s.cardLabel('var(--orange-light)', 'var(--orange)')}>⚡ SWOT Analysis — Discipline Focus</div>
          <div style={s.swotGrid}>
            {[
              { title:'Strengths', items: swot?.strengths, color:'var(--green)', bg:'var(--green-light)', icon:'✦' },
              { title:'Weaknesses', items: swot?.weaknesses, color:'var(--orange)', bg:'var(--orange-light)', icon:'◦' },
              { title:'Opportunities', items: swot?.opportunities, color:'var(--purple)', bg:'var(--purple-light)', icon:'✦' },
              { title:'Threats', items: swot?.threats, color:'var(--orange)', bg:'var(--orange-light)', icon:'⚠' },
            ].map((q, i) => (
        ...
        <div style={s.card}>
          ...
          <div style={s.planLayer}>
            ...
            <div style={s.grid2} >
              <div>
                <p style={s.planLabel}>Prioritize</p>
                <ul style={s.list}>
              ...
              <div>
                <p style={s.planLabel}>Eliminate</p>
                <ul style={s.list}>
          ...
          <div style={{...s.planLayer, borderBottom:'none', marginBottom:0, paddingBottom:0}}>
            ...
            <div style={s.grid3}>
              ...
              <div style={s.anchorBox}>
                <p style={{...s.planLabel, color:'var(--orange)'}}>Anti-Sabotage Rules</p>
                <ul style={s.list}>
        ...
        {/* CTA */}
        <div style={s.ctaBox}>
          <h2 style={s.ctaTitle}>Ready to stay accountable?</h2>
...
const s = {
  ...
  ctaTitle: { fontSize:'28px', fontWeight:'600', color:'#fff', marginBottom:'10px' },
