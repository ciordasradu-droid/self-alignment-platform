...
export default function PatternsInsight({ lang = "en" }) {
  ...
  const labels = {
    ...
    ro: {
      ...
      subtitle: "Oglinda a ce ai scris: ce se repetă — și poate n-ai văzut încă.",
      ...
      first_mirror: "Prima ta oglindă e gata. Asta face abonamentul: îți arată ce nu vezi singur.",
      too_soon: "Următoarea ta oglindă vine în {n} zile — are nevoie de material nou de reflectat.",
      next_mirror: "Următoarea oglindă e parte din abonament.",
