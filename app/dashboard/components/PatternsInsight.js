...
export default function PatternsInsight({ lang = 'en' }) {
  ...
  const labels = {
    ...
    ro: {
      tag: 'Tipare',
      title: 'Ce apare în călătoria ta',
      subtitle: 'Sinteză AI a check-in-urilor tale — tipare pe care s-ar putea să nu le vezi singur.',
      generate: 'Dezvăluie tiparele mele →',
      regenerate: 'Actualizează tiparele',
      loading: 'Analizez check-in-urile tale...',
      no_data: 'Ai nevoie de cel puțin 7 check-in-uri înainte ca tiparele să apară. Continuă să vii.',
    ...
    es: {
      tag: 'Patrones',
      title: 'Lo que está emergiendo en tu camino',
      subtitle: 'Síntesis AI de tus check-ins — patrones que quizás no ves tú mismo.',
    ...
    fr: {
      tag: 'Tendances',
      title: 'Ce qui émerge dans ton parcours',
      subtitle: 'Synthèse IA de tes check-ins — des tendances que tu ne vois peut-être pas.',
      generate: 'Révéler mes tendances →',
    ...
    de: {
      ...
      generate: 'Meine Muster enthüllen →',
      regenerate: 'Aktualisieren',
      loading: 'Analysiere deine Check-ins...',
      no_data: 'Du brauchst mindestens 7 Check-ins, bevor Muster erscheinen können.',
    ...
    pt: {
      tag: 'Padrões',
      title: 'O que está a emergir na sua jornada',
      subtitle: 'Síntese IA dos seus check-ins — padrões que talvez não veja sozinho.',
      generate: 'Revelar os meus padrões →',
      regenerate: 'Atualizar',
      loading: 'A analisar os seus check-ins...',
      no_data: 'Precisa de pelo menos 7 check-ins antes que os padrões emerjam.',
    ...
    pl: {
      tag: 'Wzorce',
      title: 'Co wyłania się w twojej podróży',
      subtitle: 'Synteza AI twoich check-inów — wzorce, których sam możesz nie widzieć.',
      generate: 'Odkryj moje wzorce →',
      regenerate: 'Odśwież',
      loading: 'Analizuję twoje check-iny...',
      no_data: 'Potrzebujesz co najmniej 7 check-inów, zanim wzorce się pojawią.',
    ...
    hu: {
      tag: 'Minták',
      title: 'Mi rajzolódik ki az utadon',
      subtitle: 'AI szintézis a check-injeidből — minták, amiket talán magadtól nem látnál.',
      generate: 'Fedezd fel a mintáimat →',
      regenerate: 'Frissítés',
      loading: 'Check-injeid elemzése...',
      no_data: 'Legalább 7 check-in kell, mielőtt a minták megjelenhetnek.',
  ...
  return (
    <div style={s.card}>
      ...
      {isOpen && (
        <div style={s.body}>
          {/* No patterns yet — show generate button */}
