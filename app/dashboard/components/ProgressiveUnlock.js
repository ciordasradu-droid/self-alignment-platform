...
const UNLOCK_TRANSLATIONS = {
  en: { opens_after: 'Opens after', days: 'days', unlocked: 'Unlocked', new: 'New', your_path: 'Your Path', path_subtitle: 'Everything unlocks with time and consistency. You can see the full map â€” each step opens when you are ready.', stages: { checkin: { l: "Daily Check-in", d: "Your daily mirror -- 3 questions." }, insight: { l: "Daily Thought", d: "A reflection calibrated to your design." }, journal: { l: "Free Journal", d: "A private space to write freely." }, plan: { l: "Alignment Plan", d: "Your personalized roadmap." }, patterns: { l: "Patterns", d: "AI synthesis of your check-ins." }, review: { l: "Weekly Review", d: "A deeper weekly reflection." }, commitment: { l: "Commitment With Yourself", d: "A document you write and sign." }, circle: { l: "The Circle", d: "4 people, compatible by design." } } },
  ro: { opens_after: "Se deschide dupa", days: "zile", unlocked: "Deblocat", new: "Nou", your_path: "Drumul Tau", path_subtitle: "Totul se deblocheaza cu timp si consecventa. Poti vedea harta completa -- fiecare pas se deschide cand esti pregatit.", stages: { checkin: { l: "Check-in Zilnic", d: "Oglinda ta zilnica -- 3 intrebari." }, insight: { l: "Gandul Zilei", d: "O reflectie calibrata pe designul tau." }, journal: { l: "Jurnal Liber", d: "Un spatiu privat de scris liber." }, plan: { l: "Plan de Aliniere", d: "Foaia ta personalizata de parcurs." }, patterns: { l: "Tipare", d: "Sinteza AI a check-in-urilor tale." }, review: { l: "Revizuire Saptamanala", d: "O reflectie saptamanala mai profunda." }, commitment: { l: "Angajament cu Tine", d: "Un document personal pe care il semnezi." }, circle: { l: "Cercul", d: "4 persoane, compatibile prin design." } } },
